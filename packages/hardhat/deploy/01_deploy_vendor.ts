...
const deployVendor: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  // Note: You'll need to replace this with your actual frontend address when deploying
  // For now, we'll keep ownership with the deployer
  // await vendor.transferOwnership("**YOUR FRONTEND ADDRESS**");

  console.log("Vendor deployed and tokens transferred!");
};
